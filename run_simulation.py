...
target_core_mass = 1.4 | units.MSun # is this a possible unit?
...
#     write_set_to_file(hydro_code.gas_particles, path+f'gas_particles_{index}.hdf5')
#     write_set_to_file(hydro_code.dm_particles, path+f'dm_particles_{index}.hdf5')
...
animator.make_animation(save_path=path+'animation.mp4')
