...
def make_velocity_plots_gas():
    ...
    for explosion_energy in explosion_energies:
        ...
        # path_simultion = path+'{:.1e}.erg/'.format(explosion_energy.value_in(units.erg), 'g)
        path_simulation = path+'{}/'.format(explosion_energy,'g')
        files = os.listdir()
...
# def check_long_run():
#     path = '/net/vdesk/data2/vanes/AMUSEproj/AMUSEproj/AMUSEproject/simulation_results/Earth_planet_12550ms/'
#     path = 'simulation_results/gas_results_hydro/4.0e+42_erg/'
#     all_relative_velocities = []
#     all_escape_velocities = []
#     all_velocities = []
#     all_escape_vel_planet = []
...
#     for j in file_numbers:
#         print('file number:', j)    
#         dm_part = read_set_from_file(path+f"dm_particles_{j}.hdf5", "hdf5")
#         gas_part = read_set_from_file(path+f"gas_particles_{j}.hdf5", "hdf5")
#         gravity_part = read_set_from_file(path+f"gravity_particles_{j}.hdf5", "hdf5")
        
#         # calculate hill radius parameters and hill radii
#         a = distance(dm_part[0], dm_part[1], unit=units.m)
...
#         M = dm_part[1].mass.value_in(units.kg) + dm_part[1].mass.value_in(units.kg)
#         # M = dm_part[0].mass.value_in(units.kg) + gravity_part[0].mass.value_in(units.kg)
#         eccentricity = 0
#         rh_planet = hill_radius(dm_part[0].mass.value_in(units.kg), M, a, eccentricity) 
#         rh_moon = hill_radius(gravity_part[0].mass.value_in(units.kg), M, a, eccentricity) 
#         rh_moon = hill_radius(dm_part[0].mass.value_in(units.kg), M, a, eccentricity) 
...
#     save_result_path = f'simulation_results/rocky_results/velocities_in_hill_sphere_moon_12550_long.png'
#     save_result_path2 = f'simulation_results/rocky_results/velocities_in_hill_sphere_planet_12550_long.png'
#     save_result_path = f'/net/vdesk/data2/evdijk/SMA/AMUSEproject-1/simulation_results/velocities_in_hill_sphere_hydro_4.0e+42.png' 
#     save_result_path2 = f'/net/vdesk/data2/evdijk/SMA/AMUSEproject-1/simulation_results/velocities_wrtplanet_in_hill_sphere_hydro_4.0e+42.png'
#     make_velocities_plot(relative_velocities_particles, escape_velocities_moon, save_result_path)
#     make_velocities_plot(velocities_particles, escape_velocities_planet, save_result_path2, option='planet')
